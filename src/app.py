...
def lambda_handler(event, context):
    for record in event['Records']:
        ...
        thumb(bucket, 'bucket-store-pillowv1', key, 'P')
        thumb(bucket, 'bucket-store-pillowv1', key, 'V')
        thumb(bucket, 'bucket-store-pillowv1', key, 'S')
        thumb(bucket, 'bucket-store-pillowv1', key, 'M')
        thumb(bucket, 'bucket-store-pillowv1', key, 'G')
        thumb(bucket, 'bucket-store-pillowv1', key, 'B')
        thumb(bucket, 'bucket-store-pillowv1', key, 'W')
